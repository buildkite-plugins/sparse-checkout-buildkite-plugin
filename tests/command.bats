...
# you can set variables common to all tests here
  export BUILDKITE_PLUGIN_SPARSE_CHECKOUT_PLUGIN_CHECKOUT_PATHS='Value'


@test "Missing mandatory option fails" {
  unset BUILDKITE_PLUGIN_SPARSE_CHECKOUT_PLUGIN_CHECKOUT_PATHS
...
@test "Optional value changes behaviour" {
  export BUILDKITE_PLUGIN_SPARSE_CHECKOUT_PLUGIN_CHECKOUT_PATHS='other value'
